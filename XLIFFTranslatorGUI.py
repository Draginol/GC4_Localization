...
class TranslationApp(QMainWindow):
    ...
    def translate_to_language(self, text, row, target_language):
        ...
        prompt = f"In the context of a sci-fi game and given the label '{label_name}' used to identify the string in a string table, translate this English string smoothly and with nuance while respecting formatting codes such as [I] into {target_language}: {text}. "
