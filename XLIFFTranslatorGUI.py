...
class TranslationApp(QMainWindow):
    ...
    def translate_to_language(self, text, row, target_language):
        ...
        prompt = f"In the context of a sci-fi game and given the label '{label_name}' to provide a bit of information, translate this English string, without using more words and respecting formatting codes that appear within [ ] into {target_language}: {text}"
